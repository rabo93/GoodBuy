...
public class LoginCheckAspect {
	// 포인트컷 설정
	// com.itwillbs.goodbuy.aop.LoginCheck 인터페이스에 해당하는 어노테이션 지정된 Target 실행전
	...
	@Before("@annotation(com.itwillbs.goodbuy.aop.LoginCheck)")
...
//	@Before("@annotation(com.itwillbs.goodbuy.aop.LoginCheck) && @annotation(loginCheck)")
