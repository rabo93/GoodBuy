        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">광고 서비스 이용 회원 및 광고 상품 리스트</h1>
					...
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th width="30px">No.</th>
                                <th class="col-2">회원 ID</th>
                                <th class="col-2">이름</th>
                                <th class="col-2">광고 상단업 구매 개수 </th>
                                <th class="col-2">광고 상단업 사용 개수</th>
                                <th class="col-2">광고 상단업 보유 개수</th>
                                <th class="col-2"></th>
                            </tr>
                        </thead>
	                            ...
	                            <tr class="AdMemberList">
	                                ...
	                                <td>
	                                	<div class="product-btn">
	                                		<a href="#" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">상품리스트</a>
										</div>
	                                </td>
	                            </tr>
	                            <tr class="AdMemberList">
