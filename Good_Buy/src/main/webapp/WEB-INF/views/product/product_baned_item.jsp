		...
		<section class="wrapper">
			<div class="page-inner">
				...
				<div>
					...
					<br>
					<br>
					온라인 개인 계정 : 개인 계정 및 인증번호를 통해 각종 피해가 발생되고 있어 굿바이 운영정책에 따라 제재 됩니다.
					<br>
					...
					<br>   
					<br>      
					사행성 : 불법 도박 및 사행성 상품은 굿바이 운영정책에 따라 제재 됩니다.
					<br>
					...
					<br>
					<br> 
					반려동물/야생동물 : 반려동물 및 야생동물은 굿바이 운영정책에 따라 제재 됩니다.
					<br>
					...
					<br>
					<br>
					신고증(허가증) 제출 필요 상품 : 신고증(허가증)을 제출하지 않고 판매 시 굿바이 운영정책에 따라 제재됩니다.
					<br>
					예시) 건강기능식품, 농축수산물(미가공), 의료기기, 식품 소분 판매, 제조 식품, 화장품(향수) 제조/판매, 상품권 예약판매, 종자/씨앗/묘목/삽수, 오토바이 렌트 및 공간대여, 부동산 중개 등 
					<br>
					<br>
					...
					<br>
					이외 국가기관에서 발행하는 바우처 및 보조금은 관련 법령에 의해 거래가 불가합니다.
					<br>
					예시) 평생교육바우처, 청년문화예술패스, 문화누리카드, 온누리상품권, 지역사랑상품권, 지역화폐, 티머니 교통카드, 네이버페이 포인트 등
					<br>
					<br>
					비트코인/가상화폐/암호화폐 : 암호화폐를 판매할 경우 굿바이 운영 정책에 따라 제재됩니다. 
					<br>
					예시) 모든 유형의 비트코인, 가상화폐, 암호화폐, 비상장코인, 파인코인, 페이코인, NFT 등
					<br>
					<br>
					불법상품 : 부정경쟁방지 및 영업비밀보호에 관한 법률에 따라 판매가 불가합니다.
					<br>
					예시) 개인차 렌트, 개통불가휴대폰, 불법소프트웨어복제품, 신용불량자(미납연체자)대상 휴대폰 개통 및 판매, 적합성 평가를 받지 않은 불법방송통신기자재 등 법률을 위반하는 상품, 불법 프로그램 (해킹프로그램, 악성프로그램, 굿바이 상품등록 프로그램)
					<br>
					<br>
					지방자치단체에서 지급 받은 학습용 디지털 기기  : 공유재산 및 물품 관리법 제 19조 (처분 등의 제한) 에 의거, 지방자치단체에서 지급 받은 행정재산은 개인이 판매할 수 없습니다. 
					<br>
					<br>
					국가로부터 수여 받은 훈장 및 포장  : 상훈법 제 40조에 따라 훈장 및 포장은 매매가 금지됩니다. (상훈법 제 40조. 정부와의 계약에 의하지 아니하고 훈장 또는 포장을 제작하거나 매매한자는 1년 이하의 징역 또는 1천만원 이하의 벌금에 처한다.)
					<br>
					예시) 대통령 국민훈장, 화랑 무공훈장, 국민훈장 동백장 등
					<br>
					<br>
					...
					<br>
					<br>
					화장품 소분/샘플판매 : 화장품 원 상품을 판매의 목적으로 의도적으로 소분하여 판매하는 것은 화장품법에 따라 판매가 불가합니다.
					<br>
					화장품 샘플, 견본품은 제품의 홍보나 테스트를 위해 제작되었으며, 화장품법에 따라 판매가 불가합니다.
					<br>
					예시) 200ml 본품을 10ml로 소분 판매, 에센스 샘플 판매 등 
					<br>
					<br>
					개인정보활용 : 개인정보를 활용한 상품 판매는 굿바이 운영정책에 따라 제재 됩니다.
					<br>
					...
					<br>
					<br>       
					총포/도검/무기/화약류 : 총포소지 허가증, 도검소지 허가증 발급이 필요한 상품으로 판매 불가 합니다.
					<br>
					예시) 총포, 도검, 화약류, 분사기, 전기충격기, 석궁, 총구에 컬러파츠(색깔 표시) 없는 비비탄 총, 진검 등
					<br>
					<br>
					...
					<br>
					열차 승차권은 철도사업법 제 10조 2항에 따라 부정 판매 및 양도할 수 없습니다.
					<br>
					예시) 내일로 패스 / 내일로 바우처 등의 열차 승차권 /  주최측 요청에 의한 재판매 불가 티켓
					<br>
					<br>
					개인 사용 목적으로 해외 직구한 전자제품 : 적합성 평가 면제조건에 해당하는 “개인이 사용할 목적의 제품”을 해외직구로 구입하여 사용하다가 중고 판매를 하고자 하는 경우 반입일로부터 1년이 경과한 경우에만 판매가 가능합니다.
					<br>
					<br>
					주식/코인/해외선물 등 투자 정보 리딩방 : 주식/코인/해외선물 리딩방 등 투자 정보를 공유하는 상품은 사기 피해 및 분쟁 발생 가능성이 있어 굿바이 운영정책에 따라 제재 됩니다.
					<br>
					예시) 국내주식 리딩, 비트코인 리딩, 해외선물 리딩 등
					<br> 
					<br>
					기타 : 폰테크 관련 상품, 상품 상태를 알 수 없는 랜덤상품, 확률형 상품, 쿠팡 나중결제 한도 판매, 유통기한 경과 상품(가공식품, 화장품, 생활용품 등 모두 포함), 개봉된 식품, 목적 불분명한 알바, 영리목적으로 제3자에게 자료 및 정보 제공, 노벨티 상품, 통신사 데이터, 정부 지원/혜택, 국산차, 수입차, 산업용 차량/장비, 자동차 렌트, 구인구직, 지역서비스(이사,용달, 호텔/숙박 영업 등), 부동산 등 거래 시 굿바이 운영정책에 따라 제재 됩니다.
					<br>
					<br> 
