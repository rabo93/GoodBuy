							...
							<section class="item-regi-img">
								...
								<div class="item-thumb">
									...
									<button class="item-thumb-upload" type="button">
										<img id="item-thumb-preview1" src="${pageContext.request.contextPath}/resources/upload/${productContent.PRODUCT_PIC1}">
									</button>
									<input type="file" class="item-thumb-upload-btn" id="item-thumb-upload-btn1" name="pic1">
								</div>
								<div class="item-thumb">
									<button class="item-thumb-upload" type="button">
										<img id="item-thumb-preview2" src="${pageContext.request.contextPath}/resources/upload/${productContent.PRODUCT_PIC2}">
									</button>
									<input type="file" class="item-thumb-upload-btn" id="item-thumb-upload-btn2" name="pic2">
								</div>
								<div class="item-thumb">
									<button class="item-thumb-upload" type="button">
										<img id="item-thumb-preview3" src="${pageContext.request.contextPath}/resources/upload/${productContent.PRODUCT_PIC3}">
									</button>
							...
							<section class="item-regi-price">
								...
								<div class="item-regi-price-box">
									...
									<div class="item-regi-price-number">
										...
										<input type="number" class="shipping-fee-price" id="shipping-fee-price" name="product_shpping_fee" value="${productContent.PRODUCT_SHPPING_FEE}" placeholder="택배비를 입력해주세요.">
